...
var second = float64(time.Second)
...
func fps(d time.Duration) float64 {
	return float64(d) / second
}

// Func for easing, transitions from begin to change from begin, t is the current time and d the duration.
type Func func(t, b, c, d float64) float64
...
// InQuart is a quartic transition based on the fourth math.Power of t that starts
// slow and speeds up
func InQuart(t, b, c, d float64) float64 {
	return c*math.Pow(t/d, 4) + b
}

// OutQuart is a quartic transition based on the fourth math.Power of t that starts
// fast and slows down
func OutQuart(t, b, c, d float64) float64 {
	return -c*(math.Pow(t/d-1, 4)-1) + b
}

// InOutQuart is a quartic transition based on the fourth math.Power of t that starts
...
// OutInQuart is a quartic transition based on the fourth math.Power of t that starts
...
// InQuint is a quintic transition based on the fifth math.Power of t that starts
// slow and speeds up
func InQuint(t, b, c, d float64) float64 {
	return c*math.Pow(t/d, 5) + b
}

// OutQuint is a quintic transition based on the fifth math.Power of t that starts
// fast and slows down
func OutQuint(t, b, c, d float64) float64 {
	return c*(math.Pow(t/d-1, 5)+1) + b
}

// InOutQuint is a quintic transition based on the fifth math.Power of t that starts
// and ends slow, accelerating through the middle
...
// OutInQuint is a quintic transition based on the fifth math.Power of t that starts
// and ends fast, slowing through the middle
...
// InExpo is a exponential transition based on the 2 to math.Power 10*t that starts
// slow and speeds up
...
// OutExpo is a exponential transition based on the 2 to math.Power 10*t that starts
// fast and slows down
...
// InOutExpo is a exponential transition based on the 2 to math.Power 10*t that
...
// OutInExpo is a exponential transition based on the 2 to math.Power 10*t that
// starts and ends fast, slowing through the middle
